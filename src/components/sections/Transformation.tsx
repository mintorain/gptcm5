            ...
            <div className="max-w-6xl mx-auto px-4">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6 max-w-4xl mx-auto mb-16">
                    {[
                        ...
                        <div key={title} className="p-6 rounded-2xl bg-white/5 border border-white/10 hover:border-purple-500/30 transition-all hover:-translate-y-1">
                ...
                <div className="max-w-2xl mx-auto">
                    <h3 className="text-xl font-bold text-white text-center mb-6">수강 혜택</h3>
                    <div className="space-y-3">
                        {[
                            { icon: CheckCircle, text: "녹화 영상 무제한 다시보기", color: "text-green-400" },
                            { icon: CheckCircle, text: "실습 템플릿 제공", color: "text-green-400" },
                            { icon: CheckCircle, text: "카카오톡 커뮤니티 참여", color: "text-green-400" },
                            { icon: CheckCircle, text: "1:1 피드백 제공", color: "text-green-400" },
                            { icon: Gift, text: "무료특강 후기 작성 시 선물 증정", color: "text-pink-400" },
                            { icon: Gift, text: "오프라인 신청 시 온라인 과정 무료!", color: "text-pink-400" },
                        ].map(({ icon: Icon, text, color }) => (
                            <div key={text} className="flex items-center gap-3 p-3 rounded-lg bg-white/5">
